...
/**
 * This class is used to test write to cassandara.This test requires a
...
public class CassndaraIOTest {
	...
	private Person[] getCloumnFamilyRows() {
		...
		CassndaraIOTest.Person person = new CassndaraIOTest.Person();
